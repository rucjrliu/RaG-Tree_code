...
#include "ragtree_update_ada.hpp"
...
#ifdef HNSW_U_ADA
    cerr << "ragtree_update_ada";
#else
    cerr << "NOT ragtree_update_ada, ERROR!" << endl;
    return -1;
#endif
...
// #endif
    ...
    else
    {
        ...
        if (flag_ada == 'a')
        {
            ...
            updated_index_save_path << "../indexfiles/rtreehnsw_u_adav2_a_" << updated_file_prefix;
        }
        else
        {
            index_save_path << "../indexfiles/rtreehnsw_s_d_" << dataset_file_prefix;
            updated_index_save_path << "../indexfiles/rtreehnsw_u_adav2_d_" << updated_file_prefix;
        }
